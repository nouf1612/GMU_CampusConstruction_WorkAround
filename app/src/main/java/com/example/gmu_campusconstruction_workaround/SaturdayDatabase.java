...
public class SaturdayDatabase extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "Saturday.db";
    public static final String TABLE_NAME = "saturday_table";
     ...
     */
    public SaturdayDatabase(@Nullable Context context) {
